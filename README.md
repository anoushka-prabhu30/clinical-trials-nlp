...
K-means (k=14) on TF-IDF embeddings split oncology trials into 3 mechanistically distinct clusters — chemotherapy toxicity (cluster 0), tumor biology (cluster 2), and Phase I dose-escalation (cluster 4) — subgroups that do not map to any single MeSH condition category. Metabolic trials (cluster 7: diabetes/insulin) and lifestyle intervention trials (cluster 5: exercise/rehabilitation) also emerged as coherent independent themes. This suggests that free-text trial descriptions carry thematic signal beyond official condition labels.
